...
There are multiple patterns for handling prototypal inheritance.  For this reason it's useful to abstract it, and offer extra features beyond what JavaScript has as standard.  Defining an API for classes keeps code simpler and makes it easier for people to navigate your code.
